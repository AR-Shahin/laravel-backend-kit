    ...
    <div class="card-body">
        <div class="card">
            ...
            <div class="row">
                ...
                <input type="text" name="name" id="nameBasic" class="form-control" value="{{ $role->name
                 }}" required>
            ...
            <div class="row g-2">
                ...
                <input type="text" name="display_name" id="emailBasic" class="form-control" value="{{ $role->display_name
                }}"  required>
                ...
                <input type="text" name="description" id="dobBasic" class="form-control" value="{{ $role->description
                }}"  required>
